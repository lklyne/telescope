...
> **Status:** Phase 0 + Phase 1 complete on `refactor/input-authority-frame-focus`. Phase 2 not started.
>
> **Decision of record:** [`docs/adr/0001-click-to-enter-frame-focus.md`](../adr/0001-click-to-enter-frame-focus.md)
>
> **Closes:** [#41](https://github.com/lklyne/specular/issues/41) once Phase 2 lands.
