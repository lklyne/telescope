...
const api: CanvasBgElectronAPI = {
  ...
  setFocus: (entityId, entityKind) => ipcRenderer.send('canvas-set-focus', { entityId, entityKind }),
  ...
  setFrameSizeMode: (frameId, mode) => ipcRenderer.send('canvas-set-frame-size-mode', { frameId, mode }),
